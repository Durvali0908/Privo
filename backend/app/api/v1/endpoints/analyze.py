...
# MetadataFindingSchema: public schema for one finding (str fields, no enums)
# MetadataSummary: envelope holding findings + extraction_success + total_findings
...
async def analyze(
    ...
    response = AnalysisResponse(
        ...
        # metadata is always populated in the Week 2 analyze endpoint.
        # It is Optional in the schema to support future endpoints where
        # metadata may not yet be available (e.g. async pipeline polling).
    )
